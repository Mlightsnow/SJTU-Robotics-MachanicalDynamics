...
%为连杆添加动力学参数
%连杆质量
L(1).m = 10*0.53717;L(2).m = 10*1.41;L(3).m = 10*0.74172;L(4).m = 10*0.45902;L(5).m = 10*0.50943;L(6).m = 10*0.10979;
%连杆质心位置
...
%连杆惯性张量
L(1).I = 100*[0.0013059	0.0017703	0.0013242	-1.57E-08	6.64E-05	-7.10E-09];
L(2).I = 100*[0.0035915	0.0057466	0.006604	1.52E-08	3.97E-10	-4.92E-10];
L(3).I = 100*[0.0013931	0.003881	0.0039521	-1.05E-07	2.33E-09	-0.00010544];
L(4).I = 100*[0.00091024	0.00089706	0.00096119	-1.05E-09	-4.52E-05	-7.87E-10];
L(5).I = 100*[0.00097574	0.00097291	0.0010393	-2.20E-08	6.26E-05	1.38E-08];
L(6).I = 100*[0.00010596	0.00010596	0.00017374	-3.28E-19	7.40E-14	-1.46E-13];
%各关节电机动力学参数
%电机惯量
...
r=sim('UR06_dynamics_sim');
t=r.find('tout');
q=r.find('yout');
qq = q{1}.Values.data;
w = [-0.8 0.8 -0.8 0.8 -0.8 0.8];
% R.plot(qq,'trail','b-','movie','r.gif')
figure(2)
R.plot3d(qq,'tilesize',0.1,'workspace',w,'nowrist','path','E:\学习电子资源\大三下\机器人学\大作业\UR06_ultimate\meshes'...
,'trail',{'r'},'movie','重力崩溃.gif');%绘制动画,并保存为gif 'movie','路径规划.gif'